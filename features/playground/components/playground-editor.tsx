...
export const PlaygroundEditor = ({
    ...
    return (
        <div className="relative h-full">
            {suggestionLoading && (
                <div className="absolute z-10 flex items-center gap-1 px-2 py-1 text-xs text-red-700 bg-red-100 rounded top-2 right-2 dark:bg-red-900 dark:text-red-300">
            ...
            {currentSuggestionRef.current && !suggestionLoading && (
                <div className="absolute z-10 flex items-center gap-1 px-2 py-1 text-xs text-green-700 bg-green-100 rounded top-2 right-2 dark:bg-green-900 dark:text-green-300">
