...
const CodeSuggestionCard: React.FC<{
    ...
    return (
        <div className="my-3 overflow-hidden transition-colors border rounded-lg border-zinc-700/50 bg-zinc-900/30 group hover:bg-zinc-900/50">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    size="sm"
                                    onClick={handleCopy}
                                    className="px-2 h-7 text-zinc-400 hover:text-zinc-200"
                                >
                                    {copied ? (
                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Button
                                            ...
                                            className="px-2 text-green-400 h-7 hover:text-green-300 hover:bg-green-500/10"
                                        >
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Button
                                    ...
                                    size="sm"
                                    onClick={onInsert}
                                    className="px-2 text-blue-400 h-7 hover:text-blue-300 hover:bg-blue-500/10"
        ...
        <TooltipProvider>
            <>
                ...
                >
                    {/* Drag overlay */}
                    {dragOver && (
                        <div className="absolute inset-0 z-10 flex items-center justify-center border-2 border-blue-400 border-dashed bg-blue-500/20">
                    ...
                    {/* Enhanced Header */}
                    <div className="border-b shrink-0 border-zinc-800 bg-zinc-900/80 backdrop-blur-sm">
                        <div className="flex items-center justify-between p-6">
                            <div className="flex items-center gap-3">
                                <div className="relative flex flex-col items-center justify-center w-10 h-10 border rounded-full">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    onClick={onClose}
                                    className="w-8 h-8 p-0 text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800"
                                >
                                    <X className="w-4 h-4" />
                                </Button>
                            </div>
                            ...
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="relative">
                                        <Search className="absolute w-3 h-3 transform -translate-y-1/2 left-2 top-1/2 text-zinc-500" />
                                        <Input
                                            placeholder="Search messages..."
                                            value={searchTerm}
                                            onChange={(e) => setSearchTerm(e.target.value)}
                                            className="w-40 h-8 pl-7 bg-zinc-800/50 border-zinc-700/50"
                                        />
                                    </div>
                        ...
                        <div className="p-6 space-y-6">
                            {filteredMessages.length === 0 && !isLoading && (
                                <div className="py-16 text-center text-zinc-500">
                                    <div className="relative flex flex-col items-center justify-center w-16 h-16 mx-auto mb-4 border rounded-full">
                                        <Brain className="w-8 h-8 text-zinc-400" />
                                    </div>
                                    <h3 className="mb-3 text-xl font-semibold text-zinc-300">
                                        Enhanced AI Assistant
                                    </h3>
                                    <p className="max-w-md mx-auto mb-6 leading-relaxed text-zinc-400">
                                        Advanced AI coding assistant with file attachments, code
                                        execution, smart suggestions, and comprehensive analysis
                                        capabilities.
                                    </p>
                                    <div className="grid max-w-lg grid-cols-2 gap-2 mx-auto">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className="px-3 py-2 text-sm text-left transition-colors rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300"
                                            >
                                                {suggestion}
                                            </button>
                                        ))}
                                ...
                                <div key={msg.id} className="space-y-4">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* Message actions */}
                                            <div className="flex items-center justify-between pt-2 mt-3 border-t border-zinc-700/30">
                                                <div className="text-xs text-zinc-500">
                                        ...
                                        {msg.role === "user" && (
                                            <Avatar className="border h-9 w-9 border-zinc-700 bg-zinc-800 shrink-0">
                            ...
                            {isLoading && (
                                <div className="flex items-start justify-start gap-4">
                                    ...
                                    <div className="flex items-center gap-3 p-5 border bg-zinc-900/80 backdrop-blur-sm border-zinc-800/50 rounded-xl rounded-bl-md">
                    ...
                    {attachments.length > 0 && (
                        <div className="p-4 border-t shrink-0 border-zinc-800 bg-zinc-900/50">
                            <div className="flex items-center justify-between mb-3 text-sm font-medium text-zinc-300">
                    ...
                    <form
                        ...
                        className="p-4 border-t shrink-0 border-zinc-800 bg-zinc-900/80 backdrop-blur-sm"
                    >
                        <div className="flex items-end gap-3">
                            <div className="relative flex-1">
                                ...
                                <div className="absolute flex items-center gap-2 right-3 bottom-3">
                                    <Button
                                        ...
                                        size="sm"
                                        onClick={() => fileInputRef.current?.click()}
                                        className="w-6 h-6 p-0 text-zinc-500 hover:text-zinc-300"
                                    >
                            ...
                            <Button
                                ...
                                className="px-4 text-white transition-colors bg-blue-600 border-0 h-11 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isLoading ? (
