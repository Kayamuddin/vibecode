...
const FilePreview: React.FC<{
    ...
    if (compact) {
        return (
            <div className="flex items-center gap-2 p-2 border rounded-lg bg-zinc-800/50 border-zinc-700/50">
        ...
        <div className="overflow-hidden border rounded-lg border-zinc-700/50 bg-zinc-900/50">
            <div className="flex items-center justify-between p-3 bg-zinc-800/50">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <Button variant="ghost" size="sm" onClick={onRemove} className="p-0 h-7 w-7 text-zinc-400 hover:text-red-400">
...
const CodeSuggestionCard: React.FC<{
    ...
    return (
        <div className="my-3 overflow-hidden border rounded-lg border-zinc-700/50 bg-zinc-900/30">
            <div className="p-3 bg-zinc-800/30">
                <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                        <h4 className="mb-1 text-sm font-medium text-zinc-200">{suggestion.title}</h4>
            ...
            >
                ...
                {dragOver && (
                    <div className="absolute inset-0 z-10 flex items-center justify-center border-2 border-blue-400 border-dashed bg-blue-500/20">
                        <div className="text-center">
                            ...
                            <p className="font-medium text-blue-400">Drop files here to attach</p>
                        </div>
                    </div>
                )}
                    ...
                    <div className="p-6 space-y-6">
                        {messages.length === 0 && !isLoading && (
                            <div className="py-16 text-center text-zinc-500">
                                ...
                                <h3 className="mb-3 text-xl font-semibold text-zinc-300">AI Code Assistant</h3>
                            ...
                            <div key={index} className="space-y-4">
                                    ...
                                    >
                                        ...
                                        {msg.role === "user" && msg.attachments && msg.attachments.length > 0 && (
                                            <div className="mt-3 space-y-2">
                                                <div className="mb-2 text-xs text-zinc-400">Attached files:</div>
                                ...
                                {msg.role === "assistant" && msg.suggestions && msg.suggestions.length > 0 && (
                                    <div className="space-y-2 ml-14">
                                        <div className="mb-3 text-sm font-medium text-zinc-300">💡 Code Suggestions:</div>
                ...
                {attachments.length > 0 && (
                    <div className="p-4 border-t shrink-0 border-zinc-800 bg-zinc-900/50">
                        <div className="mb-3 text-sm font-medium text-zinc-300">Attached Files ({attachments.length})</div>
