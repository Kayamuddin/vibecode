                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Button
                                            variant="ghost"
                                            size="sm"
                                            className="p-0 transition-colors h-7 w-7 text-zinc-400 hover:text-zinc-100 hover:bg-zinc-700/50"
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button
                                        variant="ghost"
                                        size="sm"
                                        className="p-0 text-blue-400 transition-colors h-7 w-7 hover:text-blue-300 hover:bg-blue-500/10"
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button
                                        variant="ghost"
                                        size="sm"
                                        className="p-0 text-green-400 transition-colors h-7 w-7 hover:text-green-300 hover:bg-green-500/10"
