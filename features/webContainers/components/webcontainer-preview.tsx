...
const WebContainerPreview: React.FC<WebContainerPreviewProps> = ({
    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center h-full">
                <div className="max-w-md p-6 space-y-4 text-center rounded-lg bg-gray-50 dark:bg-gray-900">
    ...
    if (error || setupError) {
        return (
            <div className="flex items-center justify-center h-full">
                <div className="max-w-md p-6 text-red-600 rounded-lg bg-red-50 dark:bg-red-900/20 dark:text-red-400">
        ...
        <div className="flex flex-col w-full h-full">
            {!previewUrl ? (
                <div className="flex flex-col h-full">
                    <div className="w-full max-w-md p-6 m-5 mx-auto bg-white rounded-lg shadow-sm dark:bg-zinc-800">
                        <h3 className='mb-4 text-lg font-medium'>Setting up your environment</h3>
