  ...
  return (
    <div className=" z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10">
      ...
      <div className="flex flex-col justify-center items-center my-5">
        ...
        <h1 className=" z-20 text-5xl mt-5 font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-rose-500 via-red-500 to-pink-500 dark:from-rose-400 dark:via-red-400 dark:to-pink-400 tracking-tight leading-[1.3] ">
          Vibe Code With Intelligence
        </h1>
      </div>

      <p className="text-lg text-center text-gray-600 dark:text-gray-400 px-5 pb-5 max-w-2xl">
